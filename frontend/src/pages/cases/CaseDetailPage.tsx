    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 mb-4">Дело не найдено</p>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{caseData.volumes_count || 0}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{caseData.documents_count || 0}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{caseData.processing_progress || 0}%</p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button
            ...
            className="bg-white rounded-xl shadow-sm p-8 hover:shadow-md transition-all text-left group"
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Тома дела</h3>
            <p className="text-gray-600">Просмотр и управление томами уголовного дела</p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600">Список всех документов дела с фильтрами</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">AI Анализ</h3>
            <p className="text-gray-600">Анализ дела с помощью искусственного интеллекта</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Стратегия защиты</h3>
            <p className="text-gray-600">Генерация и редактирование стратегии защиты</p>
          </button>

          {/* Upload Volumes */}
          <button
            onClick={() => navigate(`/cases/${id}/upload`)}
            className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl shadow-sm p-8 hover:shadow-md transition-all text-left group text-white"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center group-hover:bg-opacity-30 transition-colors">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
              </div>
              <svg className="w-6 h-6 text-white opacity-75 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </div>
            <h3 className="text-xl font-semibold mb-2">Загрузить тома</h3>
            <p className="text-blue-100">Добавить новые тома в дело</p>
          </button>
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Настройки дела</h3>
            <p className="text-gray-600">Редактирование информации о деле</p>
          </button>
        </div>
      </main>
    </div>
